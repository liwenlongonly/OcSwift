...
- (void)processDumpyRequest
{
    ...
    [self performSelector:@selector(dumpyRequestDone) withObject:nil afterDelay:1.0];
}
...
- (void)processResult
{
    ...
    _result = [[ITTRequestResult alloc] initWithCode:resultDic[@"code"] withMessage:@"message"];
