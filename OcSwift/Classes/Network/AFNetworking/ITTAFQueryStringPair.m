...
- (NSString *)urlEncodedStringValueWithEncoding:(NSStringEncoding)stringEncoding
{
    if (!self.value || [self.value isEqual:[NSNull null]]) {
        return [[self.field description] urlEncodedString];
    }
    else {
        return [NSString stringWithFormat:@"%@=%@", [[self.field description] urlEncodedString], [[self.value description] urlEncodedString]];
    }
}
